...
// 2. LIVE BROWSER CHATBOT ENGINE (Uses Your Secret API Key on Netlify - No User Input!)
async function sendChatMessage() {
    ...
    try {
        // C. Call backend function (YOUR API KEY IS SAFE ON NETLIFY SERVER!)
        ...
        document.getElementById(typingId).innerText = "Connection error. Please try again.";
    }
